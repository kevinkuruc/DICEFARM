...
##########################################################################################
include(joinpath("DICEFARM_Annual.jl"))

function create_AnimalWelfare()
m = create_dice_farm()
include(joinpath("components", "AnimalWelfare", "farm_component.jl"))
include(joinpath("components", "AnimalWelfare", "welfare_component.jl"))
