...
function create_dice_farm(;start_year=1765, end_year=2500, start_dice_year=2015, TCR::Float64=1.6, ECS::Float64=2.75, datafile=joinpath(dirname(@__FILE__), "..", "data", "DICE2016ANDFAIRParameters.xlsm"))
