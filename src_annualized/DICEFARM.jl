...
include("components/DICE/emissions_component.jl")
...
const model_years = 2015:1:2510                 #Made annual here
...
function constructdice(p)
    ...
    set_param!(m, :emissions, :MethERCP, p[:MethERCP])
    set_param!(m, :emissions, :N2oERCP, p[:N2oERCP])
